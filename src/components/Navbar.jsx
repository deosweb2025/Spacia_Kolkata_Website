    ...
    <>
      <header className="fixed top-0 left-0 right-0 w-full z-50 bg-white shadow-sm">
        <div className="max-w-[1290px] w-full mx-auto flex items-center justify-between h-[90px] px-6">
          ...
          {/* Desktop Navigation (Laptop View - Untouched) */}
          ...
          {/* CTA Button (Laptop View - Untouched) */}
          ...
          {/* Mobile Hamburger Button (Triple Lines SVG in #6BB9D2) */}
          <button
            type="button"
            onClick={() => setIsOpen(true)}
            className="lg:hidden flex items-center justify-center p-2 text-[#6BB9D2] hover:opacity-80 transition-opacity"
      ...
      {/* Mobile Slide-out Drawer (WordPress Replica) */}
      <div
